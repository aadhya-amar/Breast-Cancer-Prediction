...
def load_and_preprocess_data(file_path, model):
    if model == 'SVM':
        return svm_load_and_preprocess_data(file_path)
    elif model == 'KNN':
        return knn_load_and_preprocess_data(file_path)
    elif model == 'Voting':
        return voting_load_and_preprocess_data(file_path)
    else:
...
file_path = "C:/Users/aadhy/OneDrive/Desktop/breast cancer/data_clean (1).csv"
